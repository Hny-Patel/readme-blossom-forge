...
const WhatsAppReminder = ({
  ...
  const getMessage = () => {
    const amount = `Rs ${pendingAmount.toLocaleString("en-IN", { minimumFractionDigits: 2 })}`;
    if (accountType === "customer") {
      return `Hello ${customerName},\n\nThis is a payment reminder from ${businessName}.\n\nYou have a pending payment of ${amount}.\n\nKindly arrange the payment at your earliest convenience.\n\nThank you!`;
    } else {
      return `Hello ${customerName},\n\nThis is ${businessName}. We wanted to remind you that we have a pending payment of ${amount} due to you.\n\nPlease let us know your preferred payment method.\n\nThank you!`;
    }
  };
